export const modalInputSelect = {
    talentLevelInputSelect(parentElement: HTMLDivElement, talentSkill: string, characterTalentCurrentLevel: number, ): HTMLDivElement {
        // const $parentElement = document.getElementById("modal-body") as HTMLDivElement;
    
        const $inputSelect = document.createElement("div") as HTMLDivElement;
    ...
    characterBuildingStatusInputSelect(parentElement: HTMLDivElement, characterStatus: string) {
        const $statusInputSelect = document.createElement("div") as HTMLDivElement;
